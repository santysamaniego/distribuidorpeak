...
export default function WhatsAppFloat() {
  ...
  const handleInstagramClick = () => {
    window.open("https://instagram.com/rpdistribuidora1_", "_blank");
  };
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3 items-end">
      ...
      <motion.button
        ...
        className="bg-gradient-to-tr from-amber-500 via-pink-600 to-purple-600 hover:brightness-110 text-white p-3.5 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 border border-white/10 group"
      ...
      <motion.button
        ...
        className="bg-blue-600 hover:bg-blue-500 text-white p-4 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 border border-blue-400/20 group"
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
